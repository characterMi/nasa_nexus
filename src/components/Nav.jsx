...
const Nav = ({ start }) => {
  ...
  return (
    <section
      className={`fixed navbar max-w-[1400px] duration-300 translate-y-[-100%] text-white w-full h-20 z-50 bg-transparent backdrop-blur-lg ${
        start ? "block" : "hidden"
      }`}
    >
      ...
      <div className="flex justify-between px-2 sm:px-10 xl:px-20 w-[100%] h-[100%]">
        <div className="h-[100%] flex items-center">
          ...
          />
          <h1 className="text-2xl max-[420px]:hidden sm:text-4xl ml-2 sm:ml-5">
            Nexus SSTO
          </h1>
        </div>
